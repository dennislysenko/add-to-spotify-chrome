/*
 The Youtube module is a little different because every time you play a different song, it loads a new page--so this script gets injected again.
 So basically, each time this script is injected, i.e. each time it is run, it's like a new play of a song.
 Obviously if the user replays a video after they just saw it it won't trigger and that's fine--we don't need to reflect repeats.
 On the other hand if the user refreshes, we get a duplicate scrobble. That's just how it is, sadly.
 */
